...
![](<./performance.assets/1695617884853.png>)
...
![](<./performance.assets/1695617889552.png>)
...
![](<./performance.assets/1695617894896.png>)
...
![](<./performance.assets/1695617907745.png>)
...
![](<./performance.assets/1695617909641.png>)
...
![](<./performance.assets/1695617909974.png>)
...
![](<./performance.assets/1695617910010.png>)
...
![](<./performance.assets/1695617911575.png>)
...
![](<./performance.assets/1695617912633.png>)
...
![](<./performance.assets/1695617913637.png>)

大家留意一栏文章右侧可能会出现的图片，这里咱们给个特写：

![](<./performance.assets/1695617913670.png>)
...
![](<./performance.assets/1695617913709.png>)
...
![](<./performance.assets/1695617915808.png>)
...
![](<./performance.assets/1695617915844.png>)
...
![](<./performance.assets/1695617915881.png>)
...
![](<./performance.assets/1695617917480.png>)

![](<./performance.assets/1695617917521.png>)

**2. 简要分析**

这里我打开掘金首页，选中 `Performance` 面板中的圆箭头，来看一下页面加载过程中的性能表现：

![](<./performance.assets/1695617917556.png>)

从上到下，依次为概述面板、详情面板。下我们先来观察一下概述面板，了解页面的基本表现：

![](<./performance.assets/1695617917594.png>)
...
![](<./performance.assets/1695617918569.png>)
...
![](<./performance.assets/1695617919714.png>)
...
![](<./performance.assets/1695617921920.png>)
...
![](<./performance.assets/1695617923118.png>)

**2. 关键时间节点**

在 `performance` 的 `timing` 属性中，我们可以查看到如下的时间戳：

![](<./performance.assets/1695617924741.png>)

这些时间戳与页面整个加载流程中的关键时间节点有着一一对应的关系：

![](<./performance.assets/1695617925663.png>)
