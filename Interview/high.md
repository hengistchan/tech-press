...
![](<./high.assets/1695614007000.png>)

![](<./high.assets/1695614007036.png>)

自动执行的情况 会输出 listener1 listener2 task1 task2

![](<./high.assets/1695614007073.png>)

![](<./high.assets/1695614008677.png>)

如果手动点击 click 会一个宏任务取出来一个个执行，先执行 click 的宏任务，取出微任务去执行。会输出 listener1 task1 listener2 task2

![](<./high.assets/1695614009901.png>)
...
![](<./high.assets/1695614026202.png>)

![](<./high.assets/1695614027127.png>)
...
![](<./high.assets/1695614034753.png>)

![](<./high.assets/1695614035688.png>)
...
![](<./high.assets/1695614037727.png>)

![](<./high.assets/1695614037769.png>)
...
![](<./high.assets/1695614040988.png>)

在 B 网站，危险网站向 A 网站发起请求

会带上 A 网站的 cookie

![](<./high.assets/1695614041022.png>)

![](<./high.assets/1695614041615.png>)
...
![](<./high.assets/1695614042630.png>)

在 Cache 中也可以发现我们所需的文件已被缓存

![](<./high.assets/1695614042667.png>)
...
![](<./high.assets/1695614043454.png>)

**1. DNS 域名解析**

![](<./high.assets/1695614044170.png>)
...
![](<./high.assets/1695614046148.png>)

结合起来的过程，可以用一个图表示：

![](<./high.assets/1695614047167.png>)
...
[真正理解虚拟 DOM (opens new window)](http://interview.poetries.top/principle-docs/react/15-%E7%9C%9F%E6%AD%A3%E7%90%86%E8%A7%A3%E8%99%9A%E6%8B%9FDOM.html)
...
![](<./high.assets/1695614055856.png>)

**>=16.4 版本**

![](<./high.assets/1695614056000.png>)
...
*   [React16 为什么要更改生命周期 (opens new window)](https://interview.poetries.top/principle-docs/react/11-React16%E4%B8%BA%E4%BB%80%E4%B9%88%E8%A6%81%E6%9B%B4%E6%94%B9%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E4%B8%8A.html)
*   [React16 为什么要更改生命周期 (opens new window)](https://interview.poetries.top/principle-docs/react/12-React16%E4%B8%BA%E4%BB%80%E4%B9%88%E8%A6%81%E6%9B%B4%E6%94%B9%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F%E4%B8%8B.html)
...
![](<./high.assets/1695614060840.png>)

![](<./high.assets/1695614061106.png>)

![](<./high.assets/1695614061884.png>)

![](<./high.assets/1695614062591.png>)

![](<./high.assets/1695614062634.png>)

![](<./high.assets/1695614062909.png>)
...
![](<./high.assets/1695614064559.png>)

因为`setState`是可以接受两个参数的，一个`state`，一个回调函数。因此我们可以在回调函数里面获取值

![](<./high.assets/1695614065776.png>)
...
![](<./high.assets/1695614068300.png>)

![](<./high.assets/1695614068338.png>)

![](<./high.assets/1695614068833.png>)
...
![](<./high.assets/1695614072680.png>)

这就意味着，如果 dom 节点发生了跨层级移动，react 会删除旧的节点，生成新的节点，而不会复用。

2.  `component diff`：如果不是同一类型的组件，会删除旧的组件，创建新的组件

![](<./high.assets/1695614073286.png>)
...
![](<./high.assets/1695614076943.png>)

![](<./high.assets/1695614077499.png>)

script 标签中不添加`text/babel`解析 jsx 语法的情况下

**JSX 的本质是 React.createElement() 函数**

![](<./high.assets/1695614078747.png>)
...
![](<./high.assets/1695614079184.png>)

createElement 中并没有十分复杂的涉及算法或真实 DOM 的逻辑，它的每一个步骤几乎都是在格式化数据。

![](<./high.assets/1695614080768.png>)
...
![](<./high.assets/1695614096441.png>)

![](<./high.assets/1695614104173.png>)

[React router 原理分析 (opens new window)](http://interview.poetries.top/principle-docs/react/01-React-router%E5%8E%9F%E7%90%86.html)
...
![](<./high.assets/1695614106492.png>)

**webpack 详细工作流程**

![](<./high.assets/1695614107581.png>)
...
![](<./high.assets/1695614108516.png>)

**HMR 的基本流程图**

![](<./high.assets/1695614109708.png>)
...
![](<./high.assets/1695614111104.png>)

![](<./high.assets/1695614112290.png>)
...
[Babel 原理及其使用 (opens new window)](http://interview.poetries.top/principle-docs/webpack/05-Babel%E5%8E%9F%E7%90%86%E5%8F%8A%E5%85%B6%E4%BD%BF%E7%94%A8.html)
...
![](<./high.assets/1695614118206.png>)

![](<./high.assets/1695614119556.png>)
...
![](<./high.assets/1695614121569.png>)

![](<./high.assets/1695614124105.png>)

### 5 HTTP 之 URL

![](<./high.assets/1695614124412.png>)
...
![](<./high.assets/1695614133485.png>)

**我们通过一张图来看看它的查询过程吧**👇

![](<./high.assets/1695614135275.png>)

这张图很生动的展示了 DNS 在本地 DNS 服务器是如何查询的，**一般向本地 DNS 服务器发送请求是递归查询的**

本地 DNS 服务器向其他域名服务器请求的过程是迭代查询的过程👇

![](<./high.assets/1695614136029.png>)
...
*   我设法使销售额在 18 个月的时间里翻了三倍，从_____到_____。
...
*   我在这个领域已经工作了 X 年，我也对这个行业的薪资有所了解。在此基础上，我想我可以基于这个岗位，要求￥_____。
